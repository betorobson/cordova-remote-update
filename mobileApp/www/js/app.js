...
var app = {
	...
	wrapper: function(){
		document.querySelector('#appWrapper').innerHTML = 'Hello world 023' +
			'<br/><a href="http://cordova.apache.org/" class="external">Open link on default browser</a>';
	},

	bodyClickDelegate: function(e){
		if(e.target.matches('.external')){
			alert('Opening link on default browser');
			e.preventDefault();
